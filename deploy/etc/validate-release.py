...
SECRETS_TABLE = {
    ...
    "csrf.secret": (True, 0o600, "ega-update", "ega-update"),
    "tunnel.env": (False, 0o600, "ega-update", "ega-update"),
    ...
    "cloudflared/credentials.json": (False, 0o600, "ega-update", "ega-update"),
